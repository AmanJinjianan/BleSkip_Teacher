...
public class ControllerActivity extends Activity implements View.OnClickListener, View.OnLongClickListener{
            ...
            switch (msg.what) {
                case 13141:
                    ...
                    if(recycleCount >= 2){
                        ...
                        reveiveFlag = false;
                        Toast.makeText(ControllerActivity.this, "连上了..."+Utils.toHexString(new byte[]{theOneByte}), Toast.LENGTH_LONG).show();
                ...
                case 1234321:
                    ...
                    break;
                case 110:
                    Toast.makeText(ControllerActivity.this, "广播成功（一次）............", Toast.LENGTH_SHORT).show();
                    break;
                case 112:
                    Toast.makeText(ControllerActivity.this, "广播失败............", Toast.LENGTH_SHORT).show();
                    break;
                case 1110:
                    Toast.makeText(ControllerActivity.this, "持续广播成功............", Toast.LENGTH_SHORT).show();
                    break;
                case 11120:
                    Toast.makeText(ControllerActivity.this, "停止广播成功.............", Toast.LENGTH_SHORT).show();
                    break;
                case 11121:
                    Toast.makeText(ControllerActivity.this, "停止广播失败.............", Toast.LENGTH_SHORT).show();
                    break;
                case 10:
                    bindService(new Intent(ControllerActivity.this,BLEService.class), connection, Context.BIND_AUTO_CREATE);
                    break;
                case 11:
                    if(Tools.mBleService != null)
                        Tools.mBleService.scanBle(mLeScanCallback);
                    //Toast.makeText(ControllerActivity.this, "0000810000000000", Toast.LENGTH_LONG).show();
                    //maxSendData("0000810000000000",(byte)0xFF);
                    break;
                case 1313:
                    Toast.makeText(ControllerActivity.this, "连接成功:"+data+" ", Toast.LENGTH_LONG).show();
                    break;
                case 1314:
                    ppCount++;
                ...
                case 12:
                    ...
                    Toast.makeText(ControllerActivity.this, "连接成功", Toast.LENGTH_LONG).show();
...
//        btn_right.setEnabled(isAble);
    ...
    public boolean identifyRanData(byte[] data){
        ...
        if(data.length<15){
            Toast.makeText(ControllerActivity.this, "返回参数异常了", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void InitBle(){
        ...
        if(bAdapter == null){
            Toast.makeText(ControllerActivity.this, "not support", Toast.LENGTH_SHORT).show();
            finish();
        }
        if (bAdapter.isEnabled()) {
            setBroadcastReveiver();
            myHandler.sendEmptyMessage(10);
            //bindService(new Intent(this,ControllerActivity.class), connection, Context.BIND_AUTO_CREATE);
        }else {
            bAdapter.enable();
        }
        //setBroadcastReveiver();
    ...
    private void checkBluetoothPermission() {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            try {
                for (int i = 0; i < mPermission.length; i++) {
                    if (ContextCompat.checkSelfPermission(ControllerActivity.this, mPermission[i]) != PackageManager.PERMISSION_GRANTED) {
                        unPermissionList.add(mPermission[i]);
                    }
                }
                for (int i = 0; i < mPermission.length; i++) {
                    if (ContextCompat.checkSelfPermission(ControllerActivity.this, "android.permission.ACCESS_COARSE_LOCATION") == PackageManager.PERMISSION_GRANTED) {
                        if (isLocationEnabled()) {

                        }else {
                            Toast.makeText(ControllerActivity.this, "Please open the location switch.", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(ControllerActivity.this, "Exception0:"+e.toString(), Toast.LENGTH_LONG).show();
            }

        }else {
            InitBle();
            Toast.makeText(ControllerActivity.this, "Init.............:", Toast.LENGTH_LONG).show();
            return;
        }
        if (unPermissionList.isEmpty()) {
            ...
            try {
                ...
                Toast.makeText(ControllerActivity.this, "Exception11:"+e.toString(), Toast.LENGTH_LONG).show();
            }
        }
    ...
    public MyListener listener = new MyListener() {
       ...
       /* if (var1)
            Toast.makeText(ControllerActivity.this, "...........成功...............", Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(ControllerActivity.this, "...........失败...............", Toast.LENGTH_SHORT).show();*/
        }
    };
...
//        mSendBle.stopSend();
    ...
    public void maxSendData(String realData,byte theDirection){
        ...
        if("".equals(sendData)){
            Toast.makeText(ControllerActivity.this, "发送数据异常", Toast.LENGTH_SHORT).show();
        }else {
    ...
    private String validataData(String data) {
        ...
        if(!data.matches(regex) || (data.length()%2 !=0)){
            Toast.makeText(ControllerActivity.this, "字符串不是十六进制字符串", Toast.LENGTH_SHORT).show();
            return "";
        }

        if(data.length() != 16){
            Toast.makeText(ControllerActivity.this, "数据长度异常..", Toast.LENGTH_SHORT).show();
            return "";
        }
        return data;
    }
    ...
    public byte getSecondData(){
        ...
        if(df != null){
            ...
            Toast.makeText(ControllerActivity.this, "窗口数产生异常了", Toast.LENGTH_SHORT).show();
            return 0;
        }
    }
    ...
    public String formData(String stringData){
        if(stringData.length() != 18)
            Toast.makeText(ControllerActivity.this, "数据长度异常2..", Toast.LENGTH_SHORT).show();
